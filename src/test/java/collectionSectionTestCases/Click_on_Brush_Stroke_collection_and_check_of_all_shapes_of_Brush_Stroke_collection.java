...
public class Click_on_Brush_Stroke_collection_and_check_of_all_shapes_of_Brush_Stroke_collection extends Base{

	
	@Test
	public void Click_on_Brush_Stroke_link_and_check_of_all_shapes_of_Brush_Stroke_collection() throws InterruptedException {
		WebElement mouseover = driver.findElement(By.xpath("//a[@class='dropdown-toggle collection']"));
		Actions act = new Actions(driver);
		act.moveToElement(mouseover).perform();
		Thread.sleep(5000);
		/*driver.findElement(By.xpath("//*[@id=\"navbar-menu\"]/ul[1]/li[1]/ul/li/div/div[8]/a/img")).click();
		Thread.sleep(2000);
