...
public class Click_on_Minimalist_collection_and_check_of_all_shapes_of_Minimalist_collection extends Base{

	
	@Test
	public void Click_on_Minimalist_link_and_check_of_all_shapes_of_Minimalist_collection() throws InterruptedException {
		WebElement mouseover = driver.findElement(By.xpath("//a[@class='dropdown-toggle collection']"));
		Actions act = new Actions(driver);
		act.moveToElement(mouseover).perform();
		/*Thread.sleep(5000);
		driver.findElement(By.xpath("//*[@id=\"navbar-menu\"]/ul[1]/li[1]/ul/li/div/div[5]/a/img")).click();
		Thread.sleep(2000);
