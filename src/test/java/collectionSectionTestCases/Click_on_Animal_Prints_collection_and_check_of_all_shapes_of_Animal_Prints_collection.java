...
public class Click_on_Animal_Prints_collection_and_check_of_all_shapes_of_Animal_Prints_collection extends Base {
	
	@Test
	public void Click_on_Animal_Prints_link_and_check_of_all_shapes_of_Animal_Prints_collection() throws InterruptedException {
		WebElement mouseover = driver.findElement(By.xpath("//a[@class='dropdown-toggle collection']"));
		Actions act = new Actions(driver);
		act.moveToElement(mouseover).perform();
		/*Thread.sleep(5000);
		driver.findElement(By.xpath("/html/body/div[1]/div[1]/nav/div/div[2]/ul[1]/li[1]/ul/li/div/div[14]/a/img")).click();
		Thread.sleep(2000);
