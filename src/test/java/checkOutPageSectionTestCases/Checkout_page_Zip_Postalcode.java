...
public class Checkout_page_Zip_Postalcode extends Base{
	@Test
	public void Check_And_Verify_To_Pass_Data_In_Zip_Postalcode_Textbox_Checkout_page_Zip_Postalcode_Test() throws InterruptedException{
		Thread.sleep(3000);
