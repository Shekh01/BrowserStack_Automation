...
public class Testing_the_values_of_pile_height_density_are_loading_correctly extends Base{
	
	@Test
	public void Testing_the_values_of_pile_height_density_are_loading_correctly_Test() throws InterruptedException {
		Thread.sleep(3000);
		...
		driver.findElement(By.xpath("//a[@id='decrease']")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[@id='decrease']")).click();
		Thread.sleep(3000);
		driver.findElement(By.xpath("//a[@id='decrease']")).click();
		Thread.sleep(3000);
		//driver.findElement(By.xpath("//label[normalize-space()='14-18mm']")).click();
		
		Thread.sleep(3000);
		
		//driver.findElement(By.xpath("//label[normalize-space()='18-22mm']")).click();
